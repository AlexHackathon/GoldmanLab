...
class Simulation:
    ...
    def RunSimF(self, P0, f, t_f, startIdx=-1, dead=[], timeDead=100000000):
        ...
        while tIdx < len(self.t_vect):
            ...
            Rs[tIdx]=r_vect
            changeP = -P_rel[tIdx-1] + P0_vect + t_f*f*np.multiply(r_vect, (1-P_rel[tIdx-1])) #Maybe change the weights to be large
